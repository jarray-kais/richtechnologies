                ...
                {mine?.orders.map((order) => (
                  <tr key={order._id}>
                    ...
                    <td>
                      {order.isPaid ? (
                        order.isDelivered ? (
                          <Link to={`/detail/${order._id}`} className="action-button view-details">
                            View Details ➔
                          </Link>
                        ) : (
                          <Link  to={`/detail/${order._id}`} className="action-button view-details-progress">
                            View Details ➔
                          </Link>
                        )
                      ) : (
                        <Link className="action-button re-order" onClick={handleReorder(order._id)}>
                          Re-order ➔
                        </Link>
                      )}
                    </td>
