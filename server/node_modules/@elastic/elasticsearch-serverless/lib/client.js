...
class Client extends api_1.default {
    constructor(opts) {
        ...
        const options = Object.assign({}, {
            ...
            Transport: transport_1.Transport,
            Serializer: transport_1.Serializer,
            ConnectionPool: transport_1.CloudConnectionPool,
            maxRetries: 3,
        ...
        if (opts[kChild] !== undefined) {
            ...
            // node in the list.
            let node = (_d = options.node) !== null && _d !== void 0 ? _d : options.nodes;
